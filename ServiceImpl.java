...
//		BusTicket tt = opt.orElseThrow(() -> new Exception("Passenger not found with ticket number: " + pTktNo));
//
//		tt.setpName(pName);
//
//		tt = brepo.save(tt);
...
//		return dto;
	...
	public BusTicket fetchPassengersBypAge(String pAge) throws TicketException {
		...
		BusTicket tt = opt.orElseThrow(() -> new TicketException(" no passenger found with name " +pAge));
